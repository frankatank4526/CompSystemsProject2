...
// returns a pointer to the first inode
void *get_inodes();

// returns a pointer to the first data storage block 
void *get_blocks();


 
//returns the first free inode 
...
// Allocate a new inode and return its indexn
